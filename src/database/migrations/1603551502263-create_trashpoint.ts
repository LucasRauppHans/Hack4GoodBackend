...
export class createTrashpoint1603551502263 implements MigrationInterface {
    name = 'createTrashpoint1603551502263'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "trashpoint" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "reporterName" varchar NOT NULL, "reporterContact" varchar NOT NULL, "latitude" integer NOT NULL, "longitude" integer NOT NULL, "description" integer NOT NULL, "assignee" varchar NOT NULL, "assigneeContact" varchar NOT NULL, "severity" varchar NOT NULL)`);
